...
author: "Camilla Novaglio & Derek Tittensor And Juliano And Andrea :)"
date: "04/11/2020"
...
packages <- c(
  "grid", # Read dataframe
  "zoo", # Read dataframe (Fast!)
  "viridis",
  "tidyverse", # for all data wrangling and ggplot
  "janitor", # for data cleaning
  "ncdf4", # to order the facet wrap https://juliasilge.com/blog/reorder-within/
  "patchwork", # for figures 1 and 3
  # "ggimage", #for reading images to the circular plot
  "reshape2", # for nice plot labels
...
mainDir = my_path("G", "FishMip/Arctic")
DirStep1 = "temp_data"
ifelse(!dir.exists(file.path(mainDir, DirStep1)), dir.create(file.path(mainDir, DirStep1)), FALSE)

### define variables ###
cmip <- "cmip6"
mod_ipsl <- c("APECOSM", "BOATS", "DBEM", "DBPM","EcoOcean", "MACROECOLOGICAL", "FEISTY","ZooMSS","EcoTroph")
mod_gfdl <- c("BOATS", "DBEM", "EcoOcean", "MACROECOLOGICAL", "FEISTY","ZooMSS","EcoTroph")
protocol <- c("historical", "future")
...
save_loc <- my_path("G", "FishMip/Arctic/figures")
